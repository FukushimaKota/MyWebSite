...
<div class="delete">
<a href=bordDeleteServlet>削除</a>
</div>
<h3 class="tittle">vtuber</h3>

<p>投稿者:キズナアイファンクラブ会長</p>
<p>
...
余談だがキズナアイがAIを自称する影響で他のキャラクターも人工知能設定だと誤解されることがあるが、これも各々のキャラクターにより設定が異なる。語の初出は日本国内における類似した活動の先駆者的存在であったキズナアイが2016年12月1日に投稿した『【自己紹介】はじめまして！キズナアイですლ(´ڡ`ლ)exit』と思われる。彼女の活動一周年と登録者100万人を迎えた2017年12月頃にはジャンル全体がインターネット上で爆発的に流行し、ニコニコ大百科においてはHOTワードを席巻exit_nicochannelすることもあった。
...
ニコニコ動画等においては、キズナアイ以外にも後述の一覧に登場するキャラクターの映った動画に加え、FacerigやMMDモデルなどに何らかの方法でモーションキャプチャした動画にもバーチャルYouTuberタグが付けられることがあり、インターネット上全般においては語の初出時期なども度外視した「キズナアイに類似するもの」がバーチャルYouTuberとして認識されている傾向にある。またYouTuberやニコニコ動画だけでなくSHOWROOMやOPENREC等の動画配信サイトで活動している者もおり、その場合はバーチャルSHOWROOMERやバーチャルライバー等という呼び名を名乗っていることがある。
